...
namespace App.Migrations
{
    ...
    [Migration("20201029203749_Seed-Borrower-With-Address")]
    partial class SeedBorrowerWithAddress
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("App.Models.AddressModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("4f375627-00fc-4d3c-8175-fc57c2b14e16"),
                        ...
                        new
                        {
                            ID = new Guid("fcc822ac-55aa-4e12-9dfd-25616caae425"),
            ...
            modelBuilder.Entity("App.Models.BorrowerModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AddressID = new Guid("4f375627-00fc-4d3c-8175-fc57c2b14e16"),
                        ...
                        new
                        {
                            ...
                            AddressID = new Guid("fcc822ac-55aa-4e12-9dfd-25616caae425"),
                            CompanyIsBorrower = false,
            ...
            modelBuilder.Entity("App.Models.LoanModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2020, 10, 29, 13, 37, 49, 7, DateTimeKind.Local).AddTicks(4938),
                            IntRate = 9f,
                            IntRateLender = 8.5f,
                            ...
                            LastChangedOn = new DateTime(2020, 10, 29, 13, 37, 49, 10, DateTimeKind.Local).AddTicks(1247),
                            LoanNumber = "N1234MW",
                            LoanPoints = 4f,
                            ...
                            RegPaymentAmt = 750f,
                            Stage = 1,
                            TextNotesID = new Guid("36ae8212-14f7-4f8a-9314-71a5202e43e6"),
                            TotalLoanFee = 4000f,
                        ...
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2020, 10, 29, 13, 37, 49, 10, DateTimeKind.Local).AddTicks(3784),
                            IntRate = 9f,
                            IntRateLender = 8.5f,
                            IntRateLockDate = new DateTime(2020, 12, 25, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            LastChangedBy_id = new Guid("b282699b-5f9e-475d-85f4-5ef375e6b596"),
                            LastChangedOn = new DateTime(2020, 10, 29, 13, 37, 49, 10, DateTimeKind.Local).AddTicks(3800),
                            LoanNumber = "N5678TB",
                            LoanPoints = 4f,
                            MaturityDate = new DateTime(2021, 12, 25, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            PaymentAmortizationPeriod = 999,
                            ...
                            RegPaymentAmt = 750f,
                            Stage = 1,
                            TextNotesID = new Guid("a18ccee1-05cd-4537-af28-fc79eb7984e4"),
                            TotalLoanFee = 4000f,
                            TotalPaymentsInPeriods = 12
                        });
                });
            ...
            modelBuilder.Entity("App.Models.NoteModel", b =>
                {
                    ...
                    b.Property<bool>("Assumable")
                        .HasColumnType("bit");

                    b.Property<float>("BankruptcyAdminFee")
                        .HasColumnType("real");

                    b.Property<int>("LateChargeDays")
                        .HasColumnType("int");

                    b.Property<float>("LateChargeMinimum")
                        .HasColumnType("real");

                    b.Property<float>("LateChargePercentage")
                        .HasColumnType("real");

                    b.Property<bool>("LateFee")
                        .HasColumnType("bit");

                    b.Property<float>("MinCharge")
                        .HasColumnType("real");

                    b.Property<bool>("NoIncomeDocumentation")
                        .HasColumnType("bit");

                    b.Property<bool>("PrepaymentPenalty")
                        .HasColumnType("bit");

                    b.Property<bool>("RefundIfPaidOff")
                        .HasColumnType("bit");

                    b.Property<float>("ReturnCheckMaxFee")
                        .HasColumnType("real");

                    b.Property<float>("ReturnCheckMinFee")
                        .HasColumnType("real");

                    b.Property<float>("ReturnCheckPercentage")
                        .HasColumnType("real");

                    b.Property<bool>("SubjectToMinCharge")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("App.Models.NotesModel", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("App.Models.PropertyModel", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<float?>("AnnualInsurancePremiumAmt")
                        .HasColumnType("real");

                    b.Property<string>("City")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ConstructionDescription")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("FireInsuranceMailingCity")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("FireInsuranceMailingState")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("FireInsuranceMailingStreet")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("FireInsuranceMailingZip")
                        .HasColumnType("nvarchar(max)");

                    b.Property<float?>("FireInsurancePolicyAmt")
                        .HasColumnType("real");

                    b.Property<string>("LegalDescription")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("LossPayableClause")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<bool>("UnincorporatedArea")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("App.Models.LoanModel", b =>
                {
                    ...
                    b.HasOne("App.Models.NotesModel", "TextNotes")
                        .WithMany()
                        .HasForeignKey("TextNotesID");
                });
